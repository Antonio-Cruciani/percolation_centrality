...
function save_results_progressive_sampling(nn::String,cn::String, c::Array{Float64}, ss::Int64, t::Float64,starting_ss::Int64,xi::Float64 = -1.0,est_time::Float64 = -1.0,output_path::String = "")
    if est_time == -1.0
        if (length(c) > 0)
